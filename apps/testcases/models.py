...
class TestCases(BaseModel):
    ...
    name = models.CharField('用例名称', max_length=200, help_text='用例名称')
    interface = models.ForeignKey('interfaces.Interfaces',related_name='testcase', on_delete=models.CASCADE, help_text='所属接口')
