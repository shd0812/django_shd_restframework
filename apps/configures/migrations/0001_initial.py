    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='配置名称', max_length=200, verbose_name='配置名称')),
                ('author', models.CharField(help_text='编写人员', max_length=10, unique=True, verbose_name='编写人员')),
